window.EFFCatalog = (() => {
  ...
  async function render() {
    ...
    const {courses} = await fetch('https://raw.githubusercontent.com/estherfundsfoundation-sys/eff-leadership-academy/main/eff-leadership-academy/data/courses.json').then(r => r.json());
